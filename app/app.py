...
st.title('What\'s Up, Dweebs? 🎌')
st.header('Predict customer churn with this web application')
st.write('Use the sidebar to update the features about your client and press the \'Predict\' button see if they will churn.')
